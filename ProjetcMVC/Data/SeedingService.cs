...
namespace ProjetcMVC.Data
{
    ...
    {
        private ProjetcMVCContext _context;

        public SeedingService(ProjetcMVCContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            //Verifica se já exixte dados em Department, Seller ou SalesRecord no Banco
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@email.com", new DateTime(1979, 12, 21), 3500.00, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@email.com", new DateTime(1988, 1, 21), 2200.00, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@email.com", new DateTime(1993, 11, 21), 3000.00, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@email.com", new DateTime(2000, 1, 21), 4000.00, d3);
            Seller s6 = new Seller(6, "Alex Pink", "apink@email.com", new DateTime(1997, 3, 21), 3000.00, d2);
            ...
            //Add no Banco com AddRange = Varios
